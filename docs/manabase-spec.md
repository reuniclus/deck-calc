...
# Colourless source requirements (deck-calc, 2026-07-30)

EDH 99, turn-1 draw, so `cards seen = 7 + T`. Generated by `minSources`; regenerate with
`sourceTable` for another format.

`{C}` is TRUE colourless -- Wastes, Eldrazi Temple and similar. Coloured lands do not
produce it, so unlike coloured pips these requirements share nothing with the rest of the
manabase: a Triome serves three colour demands at once and contributes zero here.

## `X{C}` -- one colourless pip

| conf | T2 | T3 | T4 | T5 | T6 | T7 | T8 |
|---|---|---|---|---|---|---|---|
| 75% | 14 | 13 | 12 | 11 | 10 | 9 | 9 |
| 80% | 16 | 15 | 13 | 12 | 11 | 11 | 10 |
| 85% | 19 | 17 | 15 | 14 | 13 | 12 | 11 |
| **90%** | **22** | **20** | **18** | **17** | **16** | **14** | **14** |
| 95% | 27 | 25 | 23 | 21 | 20 | 18 | 17 |

## `{C}{C}` -- two colourless pips

| conf | T2 | T3 | T4 | T5 | T6 | T7 | T8 |
|---|---|---|---|---|---|---|---|
| 75% | 27 | 24 | 22 | 21 | 19 | 18 | 17 |
| 80% | 29 | 27 | 24 | 22 | 21 | 19 | 18 |
| 85% | 32 | 29 | 27 | 25 | 23 | 21 | 20 |
| **90%** | **36** | **33** | **30** | **28** | **26** | **24** | **23** |
| 95% | 42 | 38 | 35 | 33 | 30 | 28 | 27 |

## How the levers rank

At T5 and 90%:

| change | sources saved |
|---|---|
| `{C}{C}` -> `X{C}` | **11** (28 -> 17) |
| wait T5 -> T8 | 5 |
| accept 80% instead of 90% | 5 |

**Pip count dominates**, as it does for coloured requirements -- the second pip costs more
than three turns and a confidence grade combined. A turn-two `{C}{C}` requirement needs 36
sources at 90%, over a third of the deck, and 27 even at 75%; that is a card to cut rather
than a manabase to build.
